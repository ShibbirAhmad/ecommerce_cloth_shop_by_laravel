...
<a href="{{route('admin.product.create')}}" class="btn btn-primary m-2" >Add New product</a>
    <div class="card">
            <div class="card-body">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    @endif   
                       ...
                       <td colspan="2">
                            <a href="{{route('admin.product.show',$data->id)}}"  class="btn btn-dark "><i class="fas fa-eye"></i></a>   
                            <a href="{{route('admin.product.edit',$data->id)}}" style="margin-right:70px;" class="btn btn-success "><i class="fas fa-edit"></i></a>
